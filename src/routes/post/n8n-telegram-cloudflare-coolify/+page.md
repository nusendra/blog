...
When I first tried running n8n on my Raspberry Pi 5 through [Coolify](https://coolify.io), I hit a wall. All I wanted was a money-tracking app that takes input from Telegram through n8n triggers.
...
Now the webhook URL n8n handed out was actually HTTPS.

## The DNS and Cloudflare twist
...
Once I did that, Telegram triggers fired instantly.
