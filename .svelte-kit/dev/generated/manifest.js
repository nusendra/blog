...
export const routes = [
	...
	[/^\/post\/membersihkan-disk-usage-pada-ubuntu-server\/?$/, [c[0], c[37]], [c[1]]],

	// src/routes/post/method-edit-di-controller-laravel-5-part-6.md
	[/^\/post\/method-edit-di-controller-laravel-5-part-6\/?$/, [c[0], c[38]], [c[1]]],

	// src/routes/post/method-show-di-controller-laravel-5-part-5.md
	[/^\/post\/method-show-di-controller-laravel-5-part-5\/?$/, [c[0], c[39]], [c[1]]],

	// src/routes/post/cara-mudah-mengurus-atau-membuat-passport.md
	[/^\/post\/cara-mudah-mengurus-atau-membuat-passport\/?$/, [c[0], c[40]], [c[1]]],

	// src/routes/post/react-native-state-management-dengan-remx.md
	[/^\/post\/react-native-state-management-dengan-remx\/?$/, [c[0], c[41]], [c[1]]],

	// src/routes/post/fokus-sangat-membantu-kita-saat-ngoding.md
	[/^\/post\/fokus-sangat-membantu-kita-saat-ngoding\/?$/, [c[0], c[42]], [c[1]]],

	// src/routes/post/install-dan-akses-remote-mariadb-di-vps.md
	[/^\/post\/install-dan-akses-remote-mariadb-di-vps\/?$/, [c[0], c[43]], [c[1]]],

	// src/routes/post/jangan-dibuka-nanti-jadi-lemot-44440000.md
	[/^\/post\/jangan-dibuka-nanti-jadi-lemot-44440000\/?$/, [c[0], c[44]], [c[1]]],

	// src/routes/post/memajukan-komunitas-di-webunconfid-2018.md
	[/^\/post\/memajukan-komunitas-di-webunconfid-2018\/?$/, [c[0], c[45]], [c[1]]],

	// src/routes/post/docker-compose-postgresql-dan-pgadmin4.md
	[/^\/post\/docker-compose-postgresql-dan-pgadmin4\/?$/, [c[0], c[46]], [c[1]]],

	// src/routes/post/migrasi-dari-dynamic-ke-static-blog.md
	[/^\/post\/migrasi-dari-dynamic-ke-static-blog\/?$/, [c[0], c[47]], [c[1]]],

	// src/routes/post/programmer-adalah-pembelajar-sejati.md
	[/^\/post\/programmer-adalah-pembelajar-sejati\/?$/, [c[0], c[48]], [c[1]]],

	// src/routes/post/tips-dan-trik-array-pada-javascript.md
	[/^\/post\/tips-dan-trik-array-pada-javascript\/?$/, [c[0], c[49]], [c[1]]],

	// src/routes/post/membuat-rbac-sendiri-konsep-part-1.md
	[/^\/post\/membuat-rbac-sendiri-konsep-part-1\/?$/, [c[0], c[50]], [c[1]]],

	// src/routes/post/mengenal-route-di-laravel-5-part-1.md
	[/^\/post\/mengenal-route-di-laravel-5-part-1\/?$/, [c[0], c[51]], [c[1]]],

	// src/routes/post/mengenal-route-di-laravel-5-part-2.md
	[/^\/post\/mengenal-route-di-laravel-5-part-2\/?$/, [c[0], c[52]], [c[1]]],

	// src/routes/post/berkenalan-lebih-dekat-dengan-pwa.md
	[/^\/post\/berkenalan-lebih-dekat-dengan-pwa\/?$/, [c[0], c[53]], [c[1]]],

	// src/routes/post/menggunakan-knexjs-di-express-app.md
	[/^\/post\/menggunakan-knexjs-di-express-app\/?$/, [c[0], c[54]], [c[1]]],

	// src/routes/post/mengenal-middleware-di-laravel-5.md
	[/^\/post\/mengenal-middleware-di-laravel-5\/?$/, [c[0], c[55]], [c[1]]],

	// src/routes/post/jabber-xmpp-menggunakan-nodejs.md
	[/^\/post\/jabber-xmpp-menggunakan-nodejs\/?$/, [c[0], c[56]], [c[1]]],

	// src/routes/post/membangun-komunitas-surabayajs.md
	[/^\/post\/membangun-komunitas-surabayajs\/?$/, [c[0], c[57]], [c[1]]],

	// src/routes/post/menyematkan-data-pada-vue-slot.md
	[/^\/post\/menyematkan-data-pada-vue-slot\/?$/, [c[0], c[58]], [c[1]]],

	// src/routes/post/pengenalan-dasar-tentang-lumen.md
	[/^\/post\/pengenalan-dasar-tentang-lumen\/?$/, [c[0], c[59]], [c[1]]],

	// src/routes/post/groupby-array-pada-javascript.md
	[/^\/post\/groupby-array-pada-javascript\/?$/, [c[0], c[60]], [c[1]]],

	// src/routes/post/manfaat-dari-berpikir-negatif.md
	[/^\/post\/manfaat-dari-berpikir-negatif\/?$/, [c[0], c[61]], [c[1]]],

	// src/routes/post/how-to-setup-my-personal-vim.md
	[/^\/post\/how-to-setup-my-personal-vim\/?$/, [c[0], c[62]], [c[1]]],

	// src/routes/post/konfigurasi-dasar-laravel-5.md
	[/^\/post\/konfigurasi-dasar-laravel-5\/?$/, [c[0], c[63]], [c[1]]],

	// src/routes/post/struktur-folder-laravel-55.md
	[/^\/post\/struktur-folder-laravel-55\/?$/, [c[0], c[64]], [c[1]]],

	// src/routes/post/goodbye-mobx-welcome-remx.md
	[/^\/post\/goodbye-mobx-welcome-remx\/?$/, [c[0], c[65]], [c[1]]],
