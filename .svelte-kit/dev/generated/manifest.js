const c = [
	...
	() => import("../../../src/routes/work-log/0001-sub-blog-tentang-pekerjaan.md"),
	() => import("../../../src/routes/work-log.svelte"),
...
export const routes = [
	...
	// src/routes/work-log.json.js
	[/^\/work-log\.json$/],

	// src/routes/posts.json.js
	[/^\/posts\.json$/],

	// src/routes/work-log/0001-sub-blog-tentang-pekerjaan.md
	[/^\/work-log\/0001-sub-blog-tentang-pekerjaan\/?$/, [c[0], c[3]], [c[1]]],

	// src/routes/work-log.svelte
	[/^\/work-log\/?$/, [c[0], c[4]], [c[1]]],
	...
	[/^\/post\/optimasi-aset-berbasis-teks-untuk-performa-web-dengan-gzip-nginx\/?$/, [c[0], c[9]], [c[1]]],

	// src/routes/post/laravel-realtime-notification-dengan-socketio-dan-nuxtjs-part-1.md
	[/^\/post\/laravel-realtime-notification-dengan-socketio-dan-nuxtjs-part-1\/?$/, [c[0], c[10]], [c[1]]],

	// src/routes/post/laravel-realtime-notification-dengan-socketio-dan-nuxtjs-part-2.md
	[/^\/post\/laravel-realtime-notification-dengan-socketio-dan-nuxtjs-part-2\/?$/, [c[0], c[11]], [c[1]]],

	// src/routes/post/mengorganisir-api-call-di-nuxtjs-dengan-repository-pattern.md
	[/^\/post\/mengorganisir-api-call-di-nuxtjs-dengan-repository-pattern\/?$/, [c[0], c[12]], [c[1]]],

	// src/routes/post/terselamatkan-oleh-startup-script-di-google-cloud-engine.md
	[/^\/post\/terselamatkan-oleh-startup-script-di-google-cloud-engine\/?$/, [c[0], c[13]], [c[1]]],

	// src/routes/post/menentukan-teknologi-yang-tepat-sebelum-membuat-project.md
	[/^\/post\/menentukan-teknologi-yang-tepat-sebelum-membuat-project\/?$/, [c[0], c[14]], [c[1]]],

	// src/routes/post/react-native-057-images-is-not-showing-on-generated-apk.md
	[/^\/post\/react-native-057-images-is-not-showing-on-generated-apk\/?$/, [c[0], c[15]], [c[1]]],

	// src/routes/post/duplikasi-object-atau-array-dengan-benar-di-javascript.md
	[/^\/post\/duplikasi-object-atau-array-dengan-benar-di-javascript\/?$/, [c[0], c[16]], [c[1]]],

	// src/routes/post/membuat-rbac-sendiri-menu-rendering-di-nuxtjs-part-3.md
	[/^\/post\/membuat-rbac-sendiri-menu-rendering-di-nuxtjs-part-3\/?$/, [c[0], c[17]], [c[1]]],

	// src/routes/post/setup-https-ssl-di-nuxtjs-dan-laravel-dengan-nginx.md
	[/^\/post\/setup-https-ssl-di-nuxtjs-dan-laravel-dengan-nginx\/?$/, [c[0], c[18]], [c[1]]],

	// src/routes/post/transforms-absolute-ke-relative-path-di-typescript.md
	[/^\/post\/transforms-absolute-ke-relative-path-di-typescript\/?$/, [c[0], c[19]], [c[1]]],

	// src/routes/post/workshop-vuejs-basic-bersama-komunitas-surabayadev.md
	[/^\/post\/workshop-vuejs-basic-bersama-komunitas-surabayadev\/?$/, [c[0], c[20]], [c[1]]],

	// src/routes/post/redirect-http-ke-https-dengan-htaccess-di-laravel.md
	[/^\/post\/redirect-http-ke-https-dengan-htaccess-di-laravel\/?$/, [c[0], c[21]], [c[1]]],

	// src/routes/post/yank-or-copy-text-from-different-instances-of-vim.md
	[/^\/post\/yank-or-copy-text-from-different-instances-of-vim\/?$/, [c[0], c[22]], [c[1]]],

	// src/routes/post/download-private-video-youtube-dengan-youtube-dl.md
	[/^\/post\/download-private-video-youtube-dengan-youtube-dl\/?$/, [c[0], c[23]], [c[1]]],

	// src/routes/post/bagaimana-saya-mengatur-waktu-sebagai-developer.md
	[/^\/post\/bagaimana-saya-mengatur-waktu-sebagai-developer\/?$/, [c[0], c[24]], [c[1]]],

	// src/routes/post/migrasi-blog-dari-vue-gridsome-ke-svelte-sapper.md
	[/^\/post\/migrasi-blog-dari-vue-gridsome-ke-svelte-sapper\/?$/, [c[0], c[25]], [c[1]]],

	// src/routes/post/tdd-menggunakan-mocha-dan-chai-di-nodejs-part-1.md
	[/^\/post\/tdd-menggunakan-mocha-dan-chai-di-nodejs-part-1\/?$/, [c[0], c[26]], [c[1]]],

	// src/routes/post/tdd-menggunakan-mocha-dan-chai-di-nodejs-part-2.md
	[/^\/post\/tdd-menggunakan-mocha-dan-chai-di-nodejs-part-2\/?$/, [c[0], c[27]], [c[1]]],

	// src/routes/post/memproteksi-laravel-web-app-dari-serangan-csrf.md
	[/^\/post\/memproteksi-laravel-web-app-dari-serangan-csrf\/?$/, [c[0], c[28]], [c[1]]],

	// src/routes/post/mini-workshop-speed-up-development-with-nuxtjs.md
	[/^\/post\/mini-workshop-speed-up-development-with-nuxtjs\/?$/, [c[0], c[29]], [c[1]]],

	// src/routes/post/berkomunitaslah-dapatkan-dan-sebarkan-manfaat.md
	[/^\/post\/berkomunitaslah-dapatkan-dan-sebarkan-manfaat\/?$/, [c[0], c[30]], [c[1]]],

	// src/routes/post/method-destroy-di-controller-laravel-5-part-8.md
	[/^\/post\/method-destroy-di-controller-laravel-5-part-8\/?$/, [c[0], c[31]], [c[1]]],

	// src/routes/post/membuat-rbac-sendiri-backend-response-part-2.md
	[/^\/post\/membuat-rbac-sendiri-backend-response-part-2\/?$/, [c[0], c[32]], [c[1]]],

	// src/routes/post/method-create-di-controller-laravel-5-part-3.md
	[/^\/post\/method-create-di-controller-laravel-5-part-3\/?$/, [c[0], c[33]], [c[1]]],

	// src/routes/post/method-update-di-controller-laravel-5-part-7.md
	[/^\/post\/method-update-di-controller-laravel-5-part-7\/?$/, [c[0], c[34]], [c[1]]],

	// src/routes/post/rest-api-dengan-nodejs-dan-typescript-part-1.md
	[/^\/post\/rest-api-dengan-nodejs-dan-typescript-part-1\/?$/, [c[0], c[35]], [c[1]]],

	// src/routes/post/rest-api-dengan-nodejs-dan-typescript-part-2.md
	[/^\/post\/rest-api-dengan-nodejs-dan-typescript-part-2\/?$/, [c[0], c[36]], [c[1]]],

	// src/routes/post/rest-api-dengan-nodejs-dan-typescript-part-3.md
	[/^\/post\/rest-api-dengan-nodejs-dan-typescript-part-3\/?$/, [c[0], c[37]], [c[1]]],

	// src/routes/post/menampilkan-data-polymorphic-tanpa-eloquent.md
	[/^\/post\/menampilkan-data-polymorphic-tanpa-eloquent\/?$/, [c[0], c[38]], [c[1]]],

	// src/routes/post/method-index-di-controller-laravel-5-part-2.md
	[/^\/post\/method-index-di-controller-laravel-5-part-2\/?$/, [c[0], c[39]], [c[1]]],

	// src/routes/post/method-store-di-controller-laravel-5-part-4.md
	[/^\/post\/method-store-di-controller-laravel-5-part-4\/?$/, [c[0], c[40]], [c[1]]],

	// src/routes/post/install-nerdtree-dan-colorscheme-di-neovim.md
	[/^\/post\/install-nerdtree-dan-colorscheme-di-neovim\/?$/, [c[0], c[41]], [c[1]]],

	// src/routes/post/membersihkan-disk-usage-pada-ubuntu-server.md
	[/^\/post\/membersihkan-disk-usage-pada-ubuntu-server\/?$/, [c[0], c[42]], [c[1]]],

	// src/routes/post/method-edit-di-controller-laravel-5-part-6.md
	[/^\/post\/method-edit-di-controller-laravel-5-part-6\/?$/, [c[0], c[43]], [c[1]]],

	// src/routes/post/method-show-di-controller-laravel-5-part-5.md
	[/^\/post\/method-show-di-controller-laravel-5-part-5\/?$/, [c[0], c[44]], [c[1]]],

	// src/routes/post/cara-mudah-mengurus-atau-membuat-passport.md
	[/^\/post\/cara-mudah-mengurus-atau-membuat-passport\/?$/, [c[0], c[45]], [c[1]]],

	// src/routes/post/react-native-state-management-dengan-remx.md
	[/^\/post\/react-native-state-management-dengan-remx\/?$/, [c[0], c[46]], [c[1]]],

	// src/routes/post/fokus-sangat-membantu-kita-saat-ngoding.md
	[/^\/post\/fokus-sangat-membantu-kita-saat-ngoding\/?$/, [c[0], c[47]], [c[1]]],

	// src/routes/post/install-dan-akses-remote-mariadb-di-vps.md
	[/^\/post\/install-dan-akses-remote-mariadb-di-vps\/?$/, [c[0], c[48]], [c[1]]],

	// src/routes/post/jangan-dibuka-nanti-jadi-lemot-44440000.md
	[/^\/post\/jangan-dibuka-nanti-jadi-lemot-44440000\/?$/, [c[0], c[49]], [c[1]]],

	// src/routes/post/memajukan-komunitas-di-webunconfid-2018.md
	[/^\/post\/memajukan-komunitas-di-webunconfid-2018\/?$/, [c[0], c[50]], [c[1]]],
