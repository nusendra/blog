...
export const routes = [
	...
	[/^\/post\/optimasi-aset-berbasis-teks-untuk-performa-web-dengan-gzip-nginx\/?$/, [c[0], c[4]], [c[1]]],

	// src/routes/post/laravel-realtime-notification-dengan-socketio-dan-nuxtjs-part-1.md
	[/^\/post\/laravel-realtime-notification-dengan-socketio-dan-nuxtjs-part-1\/?$/, [c[0], c[5]], [c[1]]],

	// src/routes/post/laravel-realtime-notification-dengan-socketio-dan-nuxtjs-part-2.md
	[/^\/post\/laravel-realtime-notification-dengan-socketio-dan-nuxtjs-part-2\/?$/, [c[0], c[6]], [c[1]]],

	// src/routes/post/mengorganisir-api-call-di-nuxtjs-dengan-repository-pattern.md
	[/^\/post\/mengorganisir-api-call-di-nuxtjs-dengan-repository-pattern\/?$/, [c[0], c[7]], [c[1]]],

	// src/routes/post/how-to-yank-or-copy-text-from-different-instances-of-vim.md
	[/^\/post\/how-to-yank-or-copy-text-from-different-instances-of-vim\/?$/, [c[0], c[8]], [c[1]]],
	...
	[/^\/post\/duplikasi-object-dan-array-dengan-benar-di-javascript\/?$/, [c[0], c[12]], [c[1]]],
	...
	[/^\/post\/mini-workshop-speed-up-vuejs-development-with-nuxt\/?$/, [c[0], c[14]], [c[1]]],
	...
	[/^\/post\/migrasi-blog-dari-vue-gridsome-ke-svelte-sapper\/?$/, [c[0], c[19]], [c[1]]],

	// src/routes/post/tdd-menggunakan-mocha-dan-chai-di-nodejs-part-1.md
	[/^\/post\/tdd-menggunakan-mocha-dan-chai-di-nodejs-part-1\/?$/, [c[0], c[20]], [c[1]]],

	// src/routes/post/tdd-menggunakan-mocha-dan-chai-di-nodejs-part-2.md
	[/^\/post\/tdd-menggunakan-mocha-dan-chai-di-nodejs-part-2\/?$/, [c[0], c[21]], [c[1]]],

	// src/routes/post/memproteksi-laravel-web-app-dari-serangan-csrf.md
	[/^\/post\/memproteksi-laravel-web-app-dari-serangan-csrf\/?$/, [c[0], c[22]], [c[1]]],

	// src/routes/post/berkomunitaslah-dapatkan-dan-sebarkan-manfaat.md
	[/^\/post\/berkomunitaslah-dapatkan-dan-sebarkan-manfaat\/?$/, [c[0], c[23]], [c[1]]],

	// src/routes/post/method-destroy-di-controller-laravel-5-part-8.md
	[/^\/post\/method-destroy-di-controller-laravel-5-part-8\/?$/, [c[0], c[24]], [c[1]]],

	// src/routes/post/membuat-rbac-sendiri-backend-response-part-2.md
	[/^\/post\/membuat-rbac-sendiri-backend-response-part-2\/?$/, [c[0], c[25]], [c[1]]],

	// src/routes/post/method-create-di-controller-laravel-5-part-3.md
	[/^\/post\/method-create-di-controller-laravel-5-part-3\/?$/, [c[0], c[26]], [c[1]]],

	// src/routes/post/method-update-di-controller-laravel-5-part-7.md
	[/^\/post\/method-update-di-controller-laravel-5-part-7\/?$/, [c[0], c[27]], [c[1]]],

	// src/routes/post/rest-api-dengan-nodejs-dan-typescript-part-1.md
	[/^\/post\/rest-api-dengan-nodejs-dan-typescript-part-1\/?$/, [c[0], c[28]], [c[1]]],

	// src/routes/post/rest-api-dengan-nodejs-dan-typescript-part-2.md
	[/^\/post\/rest-api-dengan-nodejs-dan-typescript-part-2\/?$/, [c[0], c[29]], [c[1]]],

	// src/routes/post/rest-api-dengan-nodejs-dan-typescript-part-3.md
	[/^\/post\/rest-api-dengan-nodejs-dan-typescript-part-3\/?$/, [c[0], c[30]], [c[1]]],

	// src/routes/post/menampilkan-data-polymorphic-tanpa-eloquent.md
	[/^\/post\/menampilkan-data-polymorphic-tanpa-eloquent\/?$/, [c[0], c[31]], [c[1]]],

	// src/routes/post/method-index-di-controller-laravel-5-part-2.md
	[/^\/post\/method-index-di-controller-laravel-5-part-2\/?$/, [c[0], c[32]], [c[1]]],

	// src/routes/post/method-store-di-controller-laravel-5-part-4.md
	[/^\/post\/method-store-di-controller-laravel-5-part-4\/?$/, [c[0], c[33]], [c[1]]],

	// src/routes/post/membersihkan-disk-usage-pada-ubuntu-server.md
	[/^\/post\/membersihkan-disk-usage-pada-ubuntu-server\/?$/, [c[0], c[34]], [c[1]]],

	// src/routes/post/method-edit-di-controller-laravel-5-part-6.md
	[/^\/post\/method-edit-di-controller-laravel-5-part-6\/?$/, [c[0], c[35]], [c[1]]],

	// src/routes/post/method-show-di-controller-laravel-5-part-5.md
	[/^\/post\/method-show-di-controller-laravel-5-part-5\/?$/, [c[0], c[36]], [c[1]]],

	// src/routes/post/cara-mudah-mengurus-atau-membuat-passport.md
	[/^\/post\/cara-mudah-mengurus-atau-membuat-passport\/?$/, [c[0], c[37]], [c[1]]],

	// src/routes/post/react-native-state-management-dengan-remx.md
	[/^\/post\/react-native-state-management-dengan-remx\/?$/, [c[0], c[38]], [c[1]]],

	// src/routes/post/fokus-sangat-membantu-kita-saat-ngoding.md
	[/^\/post\/fokus-sangat-membantu-kita-saat-ngoding\/?$/, [c[0], c[39]], [c[1]]],

	// src/routes/post/install-dan-akses-remote-mariadb-di-vps.md
	[/^\/post\/install-dan-akses-remote-mariadb-di-vps\/?$/, [c[0], c[40]], [c[1]]],

	// src/routes/post/jangan-dibuka-nanti-jadi-lemot-44440000.md
	[/^\/post\/jangan-dibuka-nanti-jadi-lemot-44440000\/?$/, [c[0], c[41]], [c[1]]],

	// src/routes/post/memajukan-komunitas-di-webunconfid-2018.md
	[/^\/post\/memajukan-komunitas-di-webunconfid-2018\/?$/, [c[0], c[42]], [c[1]]],

	// src/routes/post/docker-compose-postgresql-dan-pgadmin4.md
	[/^\/post\/docker-compose-postgresql-dan-pgadmin4\/?$/, [c[0], c[43]], [c[1]]],

	// src/routes/post/dasar-controller-di-laravel-5-part-1.md
	[/^\/post\/dasar-controller-di-laravel-5-part-1\/?$/, [c[0], c[44]], [c[1]]],

	// src/routes/post/migrasi-dari-dynamic-ke-static-blog.md
	[/^\/post\/migrasi-dari-dynamic-ke-static-blog\/?$/, [c[0], c[45]], [c[1]]],

	// src/routes/post/programmer-adalah-pembelajar-sejati.md
	[/^\/post\/programmer-adalah-pembelajar-sejati\/?$/, [c[0], c[46]], [c[1]]],

	// src/routes/post/tips-dan-trik-array-pada-javascript.md
	[/^\/post\/tips-dan-trik-array-pada-javascript\/?$/, [c[0], c[47]], [c[1]]],

	// src/routes/post/membuat-rbac-sendiri-konsep-part-1.md
	[/^\/post\/membuat-rbac-sendiri-konsep-part-1\/?$/, [c[0], c[48]], [c[1]]],

	// src/routes/post/mengenal-route-di-laravel-5-part-1.md
	[/^\/post\/mengenal-route-di-laravel-5-part-1\/?$/, [c[0], c[49]], [c[1]]],

	// src/routes/post/mengenal-route-di-laravel-5-part-2.md
	[/^\/post\/mengenal-route-di-laravel-5-part-2\/?$/, [c[0], c[50]], [c[1]]],

	// src/routes/post/berkenalan-lebih-dekat-dengan-pwa.md
	[/^\/post\/berkenalan-lebih-dekat-dengan-pwa\/?$/, [c[0], c[51]], [c[1]]],

	// src/routes/post/manajemen-waktu-sebagai-developer.md
	[/^\/post\/manajemen-waktu-sebagai-developer\/?$/, [c[0], c[52]], [c[1]]],
